...
class DownsideRiskCalculator:
    ...
    def calculate_stock_risk(self, stock_data, benchmark_data):
        """计算个股的下行风险指标"""
        # 计算收益率序列
    ...
    def calculate_market_risk(self, market_data, risk_free_rate=0.0):
        """计算市场的下行风险指标"""
        # 计算收益率序列
...
if __name__ == '__main__':
    ...
    benchmark_ticker = '^GSPC'  # 标准普尔500指数代码

    # 获取下行风险指标
    stock_risk_metrics = calculator.calculate_stock_risk(stock_ticker, benchmark_ticker, '2020-01-01', '2023-04-30')
    ...
    # 获取市场下行风险指标
    market_risk_metrics = calculator.calculate_market_risk(benchmark_ticker, '2020-01-01', '2023-04-30')
    ...
    print(f"下行β系数: {market_risk_metrics['downside_beta']:.2f}")
