...
if __name__ == "__main__":
    ...
    # 爬取发帖信息（附带自动抓取该帖子下的所有评论）
    # thread1 = threading.Thread(target=post_thread, args=('601012', 1, 20))  # 设置想要爬取的股票代码，开始与终止页数
    thread2 = threading.Thread(target=post_thread, args=('600690', 10, 20))  # 可同时进行多个线程

    # 注：现在评论抓取已经内置于 post_thread 中，无需单独调用以下方法。
    # ----------------------------------------------------
