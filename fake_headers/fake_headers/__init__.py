...
from fake_headers.fake_headers.browsers import chrome, firefox, opera, random_browser
from fake_headers.fake_headers.headers import make_header
from fake_headers.fake_headers.platforms import linux, macos, random_os, windows
